...
A test set of straight top-down pixel sprites. It exists to prove sizes, the palette and the pipeline, and isn't final art. The repair station is a stand-in design. Nothing here is loaded by the game yet.
...
```
npm run sprites          # sheets/, sprites-data.js
